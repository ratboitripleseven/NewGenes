...
class BinaryClassifierDL:
    def __init__(self, name, algotrithm_type, algorithm, loss,optimizer, train_dataset, valid_dataset, test_dataset, mode='train'):
    ...
    def _set_dl_optimizer(self, optimizer, learning_rate=0.00001):
        if optimizer == 'Adam':
